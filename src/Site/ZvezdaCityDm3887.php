...
class ZvezdaCityDm3887 extends DomoPlaner implements SiteInterface
{
    public function getReportFileName(): string
    {
        return 'zvezda-city-3887' . '-' . date("Y-m-d") . '.xlsx';
    }

    public function getUrl(): string
    {
        return 'https://domoplaner.ru/widget-api/widget/413-65FOme/house-data/3887';
    }
